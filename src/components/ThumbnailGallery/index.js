...
export default class ThumbnailGallery extends Component {
    constructor (props) {
        ...
        this.gotoNextThumbnail = this.gotoNextThumbnail.bind(this);
    ...
    gotoNextThumbnail () {
        // alert('images ' + this.state.images.length + " thumbnails " + this.state.thumbnails.length + " current " + this.state.currentImage);
    ...
    buildImageRow (items, containerWidth) {
        ...
        var len = 0;
        if(this.props.enableThumbnailScroll) {
            containerWidth = containerWidth-((this.props.scrollWidth * 2) + this.props.margin);
        }
    ...
    render () {
        ...
        let iconMargin = ((this.props.rowHeight/2)*.75);
        let scroll_icon_style = {
            marginTop: iconMargin,
        }
        let scrollLeft = <div className={'thumbnail-scroll'} style={scroll_style}><a href={"#"}  onClick={this.gotoNextThumbnail}></a></div>
        let scrollRight = <div className={'thumbnail-scroll'} style={scroll_style}><span></span></div>

        images.unshift(scrollLeft)
        images.push(scrollRight)
        ...
        return (
            <div id={this.props.id} style={{borderColor:'black'}}
...
ThumbnailGallery.propTypes = {
    ...
    enableThumbnailScroll: PropTypes.bool,
};
...
// module.exports = ThumbnailGallery;